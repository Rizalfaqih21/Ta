                ...
                <tbody>
                    @foreach($pemesanans as $key => $pemesanan)
                        <tr data-entry-id="{{ $pemesanan->id }}">
                            ...
                            <td>
                                <a class="btn btn-xs btn-success" href="{{ route('teknisi.pemesanans.show', $pemesanan->id) }}">
                                    Terima
                                </a>
                                
                                <a class="btn btn-xs btn-warning" href="{{ route('teknisi.pemesanans.show', $pemesanan->id) }}">
                                    Tolak
                                </a>
