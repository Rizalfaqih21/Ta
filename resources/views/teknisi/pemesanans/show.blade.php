...
<div class="card">
    ...
    <div class="card-body">
        <div class="form-group">
            <div class="form-group">
                <a class="btn btn-default" href="{{ route('teknisi.pemesanans.index') }}">
...
<div class="card">
    ...
    <div class="tab-content">
        <div class="tab-pane" role="tabpanel" id="pemesanan_riwayat_pemesanans">
            @includeIf('teknisi.pemesanans.relationships.pemesananRiwayatPemesanans', ['riwayatPemesanans' => $pemesanan->pemesananRiwayatPemesanans])
        </div>
    </div>
</div>
